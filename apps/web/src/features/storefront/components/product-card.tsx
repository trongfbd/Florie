...
export function ProductCard({ product }: { product: ProductListItem }) {
  ...
  return (
    <Link
      ...
      className="group block overflow-hidden rounded-brand border border-primary/60 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
    >
      <div className="relative aspect-square overflow-hidden bg-secondary">
        ...
        {hasDiscount && (
          <span className="absolute left-3 top-3 rounded-full bg-accent px-2.5 py-1 text-xs font-semibold text-white shadow-sm">
            Giảm giá
          </span>
        )}
      </div>
